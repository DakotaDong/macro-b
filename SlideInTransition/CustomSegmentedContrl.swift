...
class CustomSegmentedContrl: UIControl {
    ...
    @IBInspectable var textColor: UIColor = UIColor(red: 0.40, green: 0.40, blue: 0.40, alpha: 1.00) {
    ...
    @IBInspectable var selectorColor: UIColor = UIColor(red: 0.96, green: 0.66, blue: 0.15, alpha: 1.00) {
    ...
    @IBInspectable var selectorTextColor: UIColor = UIColor(red: 0.40, green: 0.40, blue: 0.40, alpha: 1.00) {
